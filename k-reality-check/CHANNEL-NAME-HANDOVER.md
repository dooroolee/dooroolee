# 유튜브 채널명 결정 — 인수인계 (새 대화창용)

> 새 대화창에 이 문서 전체를 붙여넣고 "이어서 채널명 정하자"라고 지시.
...
## 다음에 할 일
1. **`@koreacandid` 핸들 실제 공석 확인** — 유튜브·인스타·틱톡 3곳 (웹검색 + 직접 접속)
2. 최종 확정
3. (확정 후) 서브 태그라인·시리즈명 구성 — 예: 채널 KOREACANDID / 검증 시리즈 "Reality Check" / 추천 시리즈 "Local's Best 10"
4. (별도 세션) **EP1의 "K-Reality Check" 표기 교체**: 아웃트로 자막·설명란 무료 수정 + 아웃트로 나레이션 그 한 문장만 힉스필드 VO 재생성(~2크레딧, Leo 보이스 id 73a45c18-0c56-4642-a61e-f6b303f8ded1)
